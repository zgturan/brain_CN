...
number_of_CN5 <- readRDS("./turan/data/processed/rds/number_of_CN5.rds")
###########################################################
number_of_CN6= rbind()
...
turan_cnv_stat <- readRDS("./turan/data/processed/rds/turan_cnv_stat.rds")
dim(turan_cnv_stat)
# 1026   8
...
head(turan_cnv_stat)
saveRDS(turan_cnv_stat, file ="./turan/data/processed/rds/turan_cnv_stat_check_genome.rds")