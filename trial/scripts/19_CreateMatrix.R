...
CN_table <- readRDS(paste0(outpath, "CN_table_thres_svd_genome.rds"))
...
infox <- readRDS(paste0(outpath, "CN_table_thres_svd_genome.rds"))
...
saveRDS(CN_tablexx5, file= paste0(outpath, "thres_svd_matrix.rds"))
